...
var deleteExcessKeys = function (options) {
    ...
    var deleteKeys = Object.keys(constants_1.TRANSFORM_OPTION_KEY).concat(constants_1.CONFIG_SHAPE.map(function (item) { return item.key; }), constants_1.COORDIANTE_OPTIONS);
