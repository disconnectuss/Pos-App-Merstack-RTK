...
var Plot = /** @class */ (function (_super) {
    ...
    function Plot(container, options) {
        ...
        _this.options = (0, utils_1.mergeWithArrayCoverage)({}, _this.getBaseOptions(), _this.getDefaultOptions(), options);
        _this.createG2();
        _this.bindEvents();
        return _this;
    }
    ...
    Plot.prototype.updateOption = function (options) {
        this.options = (0, utils_1.mergeWithArrayCoverage)({}, this.options, options);
    };
    /**
     * 更新数据
     * @override
