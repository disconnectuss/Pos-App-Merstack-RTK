...
exports.Sunburst = exports.transformData = exports.SUNBURST_ANCESTOR_FIELD = exports.SUNBURST_PATH_FIELD = exports.SUNBURST_Y_FIELD = exports.SUNBURST_TYPE_FIELD = exports.SUNBURST_TYPE = void 0;
...
function transformData(options) {
    ...
    return result.map((d) => (Object.assign(Object.assign({}, d), { x: d.x.slice(0, 2), y: [d.y[2], d.y[0]], fillOpacity: Math.pow(0.85, d.depth) })));
}
